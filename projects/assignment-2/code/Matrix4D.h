...
namespace {
	...
	Matrix4D::Matrix4D(const Matrix4D& inMatrix) {
	...
	Matrix4D::Matrix4D(float inMatrix[16])
	{
		matrix[0] = inMatrix[0];
		matrix[1] = inMatrix[1];
		matrix[2] = inMatrix[2];
	...
	Matrix4D Matrix4D::operator*(const Matrix4D& inMatrix) const {
	...
	Matrix4D Matrix4D::operator*(const float scaler) const {
		float temparr[16];
	...
	float Matrix4D::operator[](const int index) const {
		return matrix[index];
	}
	...
	Matrix4D Matrix4D::transpose(const Matrix4D& inMatrix) {
		float temparr[16];
	...
	Matrix4D Matrix4D::rotX(float rotation)
	{
	...
	Matrix4D Matrix4D::rotY(float rotation)
	{
		float sinus = sinf(rotation);
		float cosinus = cosf(rotation);
	...
	Matrix4D Matrix4D::rotZ(float rotation)
	{
		float sinus = sinf(rotation);
		float cosinus = cosf(rotation);
	...
	Vector4D Matrix4D::operator*(const Vector4D& inVector) const {
	...
	Matrix4D Matrix4D::inverse(const Matrix4D& inMatrix) {
		double inv[16], det;
		float invOut[16];
		int i;
	...
	Matrix4D Matrix4D::rotVector(const Vector4D& inVector, const float rad) {
	...
	Matrix4D Matrix4D::getPositionMatrix(Vector4D& inVector) {
		float temparr[16];
