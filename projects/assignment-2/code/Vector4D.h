...
namespace {
	...
	Vector4D Vector4D::operator+(const Vector4D& inVector) const {
	...
	Vector4D Vector4D::operator*(const float scaler) const {
	...
	float Vector4D::dotProduct(const Vector4D& inVector) const {
	...
	Vector4D Vector4D::crossProduct(const Vector4D& inVector) const {
	...
	float Vector4D::getFloat(int i) const {
		return vector[i];
	}
}
